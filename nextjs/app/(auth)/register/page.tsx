    ...
    const handleRegister = async (e: React.FormEvent) => {
      ...
      try {
        ...
        const message =
          ...
          err?.response?.data?.message || // or fallback message
          err?.message ||
          "Registration failed";
        setError(message);
        setIsLoading(false);
      ...
      <div className="w-full max-w-md bg-gray-800 bg-opacity-90 rounded-2xl shadow-lg text-white overflow-hidden ">
        ...
        <div className="relative h-[220px] w-full">
          ...
          <div className="absolute bottom-4 left-0 w-full px-6">
            ...
            <p className="text-sm text-gray-300">Register to continue</p>
          </div>
        </div>
        ...
        <div className="p-8 pt-6">
          <form onSubmit={handleRegister}>
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center bg-gray-700 rounded px-3 py-2">
                <MdPassword size={25} className="mr-2" />
                <input
                  id="password"
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center bg-gray-700 rounded px-3 py-2">
                ...
                {/* Show green tick if passwords match */}
                {passwordsMatch && (
                  <FaCheckCircle
                    size={20}
